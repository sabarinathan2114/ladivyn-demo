...
const MastersCategory = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure? This may affect linked products and subcategories.')) {
      try {
    ...
    <div>
      <div className="header-actions">
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)' }}>Manage top-level store groupings.</p>
        </div>
...
export default MastersCategory;
