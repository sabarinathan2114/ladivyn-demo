...
const ProductSection = () => {
  ...
  return (
    <section className="relative w-full py-20 px-4 md:px-8 bg-[#170a10] bg-[url('/images/productsection2-bg.webp')] bg-cover md:bg-size-[100%_100%] bg-bottom bg-no-repeat overflow-hidden text-center text-[#F8F8F8] border-b border-[#8c7468]/50">
      {/* Optional dark overlay for readability */}
      <div className="absolute inset-0 z-0 bg-[#1e0a13]/60 sm:bg-transparent"></div>
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center">
        {/* Headings */}
        <div className="mb-12 max-w-6xl">
          <h2 className="font-['Playfair_Display',serif] text-2xl md:text-3xl lg:text-4xl font-normal leading-tight mb-4 text-[#e6ddca]">
            Elements of the Earth, Cultivated for the Modern World.
          </h2>
          <p className="font-['Playfair_Display',serif] italic text-sm md:text-base lg:text-lg text-[#beaca4] tracking-wide">
        ...
        <div className="w-full flex items-center justify-center mb-10 max-w-5xl">
          ...
          <span className="px-6 font-['Cinzel',serif] font-bold text-[#e6ddca] text-sm md:text-base tracking-[0.2em]">
            FEATURED GEMS
          </span>
          <div className="h-[2px] bg-[#8c7468] flex-grow opacity-80"></div>
        </div>
