...
const DashboardLayout = () => {
  ...
  const menuItems = [
    ...
    { icon: Layers, label: 'Master Data Settings', path: '/dashboard/masters' },
  ];
  ...
  return (
    <div className={`layout-container ${isSidebarOpen ? 'sidebar-open' : ''}`}>
      ...
      <aside className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          <div style={{ 
            ...
            borderRadius: '4px', color: '#1a1510', fontWeight: 'bold', fontSize: '1.2rem'
          }}>
            L
          </div>
        ...
        <div className="sidebar-footer">
          <button 
            ...
            style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', border: 'none', cursor: 'pointer', background: 'transparent' }}
          >
            <LogOut size={20} />
      ...
      <main className="main-content">
        <header className="topbar">
          ...
          <div className="user-profile">
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              <p style={{ color: '#94a3b8', fontSize: '0.75rem', textTransform: 'capitalize' }}>{user.role}</p>
            </div>
        ...
        <div className="content-area" onClick={() => isSidebarOpen && setIsSidebarOpen(false)}>
          <Outlet />
        </div>
      </main>
    </div>
